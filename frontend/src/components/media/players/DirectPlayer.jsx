 ...
 * 
 * Handles native HTML5 video playback for direct media links (like .mp4).
 * It attaches React event listeners to the native `<video>` element and passes those events
 * to the custom `useDirectSync` hook to broadcast playback state to the rest of the room.
 * 
